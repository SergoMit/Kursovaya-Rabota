...
class working_process:
    def __init__(self, game):
        self.game = game
        self.field_image = self.get_scaled_image(path='Images/field42_pgm.png', res=[WIN_SIZE] * 2)
        self.O_image = self.get_scaled_image(path='Images/nolik11_pgm.png', res=[CELL_SIZE] * 2)
        self.X_image = self.get_scaled_image(path='Images/krestik11_pgm.png', res=[CELL_SIZE] * 2)
